...
const createEnrollment = async (req, res) => {
  try {
    ...
    if (!contact_no) {
     ...
     if (middle_initial && middle_initial.length > 3) errors.middle_initial = "Middle Initial is maximum of 3 characters only."
    ...
    const capitalizedMiddleInitial = middle_initial ? middle_initial.charAt(0).toUpperCase() + middle_initial.slice(1) : '';
